...
//     let greatBlock = document.createElement('div');
//     let blockTitle = document.createElement('div');
//     blockTitle.classList.add('title');
//     let blockMonth_Hour = document.createElement('div');
//     blockMonth_Hour.classList.add('month___hour___duration');
//     let monthBlock = document.createElement('div');
//     monthBlock.classList.add('month___duration');
//     let hourBlock = document.createElement('div');
//     hourBlock.classList.add('hour___duration');
...
//     monthBlock.innerText = item.monthDuration;
//     hourBlock.innerText = item.hourDuration;
//     document.body.appendChild(greatBlock);
//     greatBlock.appendChild(blockTitle);
//     greatBlock.appendChild(blockMonth_Hour);
//     blockMonth_Hour.style.display = 'flex';
//     blockMonth_Hour.appendChild(monthBlock);
//     monthBlock.style.marginRight = '20px'
//     blockMonth_Hour.appendChild(hourBlock);
//     greatBlock.appendChild(modulesBlock);
//     for (let modulesItem of item.modules) {
//         let liBlock = document.createElement('li');
//         liBlock.innerText = modulesItem;
//         modulesBlock.appendChild(liBlock);
//     }
//
// }